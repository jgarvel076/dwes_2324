...
try { 
    ...
    $mail->Username = 'juliangv11204@gmail.com';
    $mail->Password = 'ymix lhph rogf kyxj';
    ...
    //Cabecera del emial
    $destinatario = 'jgarvel076@g.educaand.es';
    $remitente    = 'juliangv11204@gmail.com';
    ...
    $mail->setFrom($remitente, 'Julian');
    $mail->addAddress($destinatario, 'Pedro');
    $mail->addReplyTo($remitente, 'Julian');
