<?php 
    ...
    public function validateEmailUnique($email) {
        ...
        try {
            ...
            $selectSQL = "SELECT * FROM gescomercial.users WHERE email = :email";
            $pdo = $this->db->connect();
    ...
    public function create ($name, $email, $pass) {
        try {
            ...
            $insertarsql = "INSERT INTO gescomercial.users VALUES (
                 null,
                :nombre,
                :email,
                :pass,
            ...
            $role_id = 3;
            $insertarsql = "INSERT INTO gescomercial.roles_users VALUES (
                null,
                :user_id,
                :role_id,
                default,
